...
// est sauvegardé et affiché dans un classement partagé.
// ============================================================
...
// Clé utilisée pour stocker les scores dans le stockage local
const STORAGE_KEY = "justeprix_scores";
...
window.addEventListener("load", () => {
    afficherClassement();       // On charge et affiche les scores existants
...
// ============================================================
// SAUVEGARDE DU SCORE (Corrigé avec localStorage)
// ============================================================
function sauvegarderScore(pseudo, score) {
    // On récupère les scores existants
    let scores = recupererScores();

    // On cherche si ce pseudo a déjà un score
    const existant = scores.find(s => s.pseudo.toLowerCase() === pseudo.toLowerCase());

    if (!existant) {
        scores.push({ pseudo: pseudo, score: score });
    } else if (score < existant.score) {
    ...
    // Sauvegarde officielle dans le navigateur !
...
// ============================================================
// RÉCUPÉRATION DES SCORES (Corrigé avec localStorage)
// ============================================================
